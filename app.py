...
if not st.session_state.logged_in:
    st.markdown("<h1 style='text-align: center; color: #0d47a;'>Welcome to BudgetWise AI Forecasting</h1>", unsafe_allow_html=True)
...
# DASHBOARD
    ...
    # USER DASHBOARD
        ...
        c1, c2 = st.columns([6, 1])
        c1.title(f"Welcome To BUDGETWISE AI FORECASTING , {st.session_state.username}")
        if c2.button("Logout"):
            st.session_state.clear(); st.rerun()
        ...
        t1, t2, t3, t4 = st.tabs(["Manage", "Analysis", "Goals", "Forecast"])
